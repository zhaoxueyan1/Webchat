    ...
    <div class="admin-content">
        <div class="" style="width: 80%;float:left;">
            ...
            <div class="am-btn-group am-btn-group-xs" style="float:right;">
                <input type="file" name="file" id="file" onchange="sendFile()" style="display:none">
                <button class="am-btn am-btn-default" type="button" onclick="select_file()"><span class="am-icon-plug"></span> 上传图片</button>
                ...
                <button class="am-btn am-btn-default" type="button" onclick="getConnection()"><span class="am-icon-plug"></span> 查询</button>
...
<script>
    ...
    function analysisMessage(message){
        ...
        if(message.type == "img"){      //会话消息
            showImg(message.message);
        }
    ...
    function showImg(message){
        ...
        var html = "<li class=\"am-comment "+isSef+" am-comment-primary\"><a href=\"#link-to-user-home\"><img width=\"48\" height=\"48\" class=\"am-comment-avatar\" alt=\"\" src=\"${ctx}/"+message.from+"/head\"></a><div class=\"am-comment-main\">\n" +
            "<header class=\"am-comment-hd\"><div class=\"am-comment-meta\">   <a class=\"am-comment-author\" href=\"#link-to-user\">"+message.from+"</a> 发表于<time> "+message.time+"</time> 发送给: "+to+" </div></header><div class=\"am-comment-bd\"> <img src="+message.content+" alt='img'></div></div></li>";
    ...
    <%--<form id="register-form" action="<%=path%>/user/register" method="post" onsubmit="return checkRegisterForm()">--%>
        ...
        $.each(list, function(index, item){     //添加私聊按钮
            var li = "<li>"+item+"</li>";
            if('${userid}' != item){    //排除自己
                li = "<li>"+item+" <button type=\"button\" class=\"am-btn am-btn-xs am-btn-primary am-round\" onclick=\"return showIllegal()\">" +
                    "<span class=\"am-icon-phone\"><span> 举报</button></li>";
